...
class MACDStrategy(strategy.BacktestingStrategy):
    ...
    def getExpectdShares(self, risk_adjust_factor, sigma, position_sigma = 5):
        ...
        return int(total_asserts * self.__total_risk * risk_adjust_factor / ((position_sigma * sigma) * 100))
    ...
    def getNewSignal(self, bars):
        ...
        for instrument in self.__instruments:
            ...
            if len(self.__macd_dict[instrument].double_bottom_divergences) == 0 and len(self.__macd_dict[instrument].double_top_divergences) == 0: continue
            for double_divergence in self.__macd_dict[instrument].double_top_divergences:
                ...
                if instrument in actualPostions:
